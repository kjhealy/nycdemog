# Build nyc_block_20_race_df: 2020 Decennial race x Hispanic origin counts
# at the Census block level for the five NYC counties.
#
...
usethis::use_data(nyc_block_20_race_df, overwrite = TRUE, compress = "xz")
