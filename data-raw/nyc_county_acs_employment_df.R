# Build nyc_county_acs_employment_df: labor force status from the latest
...
nyc_county_acs_employment_df <- raw |>
  select(
    geoid,
    county,
    name,
...
attr(nyc_county_acs_employment_df, "acs_year") <- attr(raw, "acs_year")
attr(nyc_county_acs_employment_df, "acs_survey") <- attr(raw, "acs_survey")
