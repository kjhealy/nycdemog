# Build nyc_tract_acs_race_df: race and Hispanic origin from the latest
...
attr(nyc_tract_acs_race_df, "acs_year") <- attr(raw, "acs_year")
attr(nyc_tract_acs_race_df, "acs_survey") <- attr(raw, "acs_survey")

usethis::use_data(nyc_tract_acs_race_df, overwrite = TRUE, compress = "xz")
