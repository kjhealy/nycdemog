# Build nyc_tract_20_age_sex_df: 2020 Decennial sex by age at the Census tract
...
usethis::use_data(nyc_tract_20_age_sex_df, overwrite = TRUE, compress = "xz")
