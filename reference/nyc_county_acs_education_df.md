...
City counties (boroughs). Sourced from ACS table B15003. Each estimate
is accompanied by its 90% margin of error, with the suffix `_moe`. The
county-level counterpart of
[nyc_tract_acs_education_df](https://kjhealy.github.io/nycdemog/reference/nyc_tract_acs_education_df.md).
Joins to
...
A tibble with 5 rows and 26 columns:
